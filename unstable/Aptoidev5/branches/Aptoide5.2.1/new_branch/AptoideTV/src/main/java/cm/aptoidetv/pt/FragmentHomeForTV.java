 ...
 */
public class FragmentHomeForTV extends ListFragment implements LoaderManager.LoaderCallbacks<HashMap<String, ArrayList<Home>>>, SwipeRefreshLayout.OnRefreshListener {
...
//getListView().setLayoutAnimation(AnimationUtils.loadLayoutAnimation(getActivity(), R.anim.layout_anim));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        header = getLayoutInflater(null).inflate(cm.aptoidetv.pt.R.layout.header_home, null);
        Button search = (Button) header.findViewById(cm.aptoidetv.pt.R.id.button_search);
