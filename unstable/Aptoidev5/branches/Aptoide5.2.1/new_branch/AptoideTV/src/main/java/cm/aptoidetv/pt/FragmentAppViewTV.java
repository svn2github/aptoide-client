...
public abstract class FragmentAppViewTV extends Fragment {
    ...
    public static class FragmentScreenshots extends FragmentAppViewTV {
        private LinearLayout mainLayout;

        @Subscribe
        public void refreshDetails(final AppViewActivityTV.ScreenshotsEvent event) {
...
//                        Log.d("FragmentAppView", "IMAGEPATH: " + imagePath);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View v = inflater.inflate(R.layout.fragment_screenshots, container, false);
...
//        private ScrollView scroller;
        ...
        @Subscribe
        public void refreshDetails(final AppViewActivityTV.DetailsEvent event) {
...
//                            scroller.scrollTo(0, scrollPosition);
            ...
            if(((AppViewActivityTV)getActivity()).isMultipleStores()){
            ...
            if(event.getDeveloper() != null){
                ...
                if(((AppViewActivityTV)getActivity()).isUpdate()){
            ...
            public void onRequestFailure(SpiceException spiceException) {
                ...
                errorBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        listRelatedApkRequest.setVercode(((AppViewActivityTV) getActivity()).getVersionCode());
                        listRelatedApkRequest.setLimit(develBasedAdapter.getBucketSize());
                        listRelatedApkRequest.setPackageName(((AppViewActivityTV) getActivity()).getPackage_name());

                        spiceManager.execute(listRelatedApkRequest, ((AppViewActivityTV) getActivity()).getPackage_name() + "-related", DurationInMillis.ONE_DAY, request);
                    ...
                    if(relaatedlist.size()>0) {
                        ...
                        v.findViewById(R.id.more).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                i.putExtra("versionCode", ((AppViewActivityTV) getActivity()).getVersionCode());
                                i.putExtra("appName", ((AppViewActivityTV) getActivity()).getName());
...
//            View v = inflater.inflate(cm.aptoidetv.pt.R.layout.fragment_app_view_related, container, false);
//            relatedListView = (ListView) v.findViewById(cm.aptoidetv.pt.R.id.list_related);
        ...
        @Subscribe
        public void refresh(AppViewActivityTV.RelatedEvent e){
            doPreStuff();
        }
        ...
        private final void doPreStuff(){
            ...
            if(!((AppViewActivityTV)getActivity()).isMultipleStores()){
                listRelatedApkRequest.setRepos(((AppViewActivityTV)getActivity()).getRepoName());
            }
            listRelatedApkRequest.setVercode(((AppViewActivityTV)getActivity()).getVersionCode());
            listRelatedApkRequest.setLimit(develBasedAdapter.getBucketSize());
            listRelatedApkRequest.setPackageName(((AppViewActivityTV)getActivity()).getPackage_name());
...
//            };
    ...
    public static class FragmentAppViewSpecs extends FragmentAppViewTV {
        ...
        @Subscribe
        public void refreshDetails(final AppViewActivityTV.SpecsEvent event) {
    ...
    public static class FragmentAppViewRating extends FragmentAppViewTV implements SuccessfullyPostCallback {
        ...
        public void onAttach(Activity activity) {
            ...
            ((AppViewActivityTV) activity).setSuccessfullyPostCallback(this);
        }
        ...
        public void onDetach() {
            ...
            ((AppViewActivityTV) getActivity()).setSuccessfullyPostCallback(null);

        }

        @Subscribe
        public void refreshDetails(final AppViewActivityTV.RatingEvent event) {
            //Log.d("Aptoide-AppView", "getting event");
                ...
                if (event.getComments().size() == 0) {
                    ...
                    seeAllButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.putExtra("packageName", ((AppViewActivityTV) getActivity()).getPackage_name());
                            intent.putExtra("token", ((AppViewActivityTV) getActivity()).getToken());
...
/*
                ...
                flagThisApp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (ac.getAccountsByType(AptoideTV.getConfiguration().getAccountType()).length > 0) {
                            ...
                            ac.addAccount(AptoideTV.getConfiguration().getAccountType(), AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS, null, null, getActivity(), null, null);
                        }
                    }
                });
            }
            ...
            RequestListener<GenericResponse> requestListener = new RequestListener<GenericResponse>() {
                ...
                public void onRequestSuccess(GenericResponse genericResponse) {
                    ...
                    if(genericResponse.getStatus().equals("OK")){
                        Toast.makeText(AptoideTV.getContext(), getString(R.string.opinion_success), Toast.LENGTH_LONG).show();
                        manager.removeDataFromCache(GetApkInfoJson.class, ((AppViewActivityTV)getActivity()).getCacheKey());
...
//                manager = ((AppViewActivityTV)getActivity()).getSpice();
//
//                AddLikeRequest request = new AddLikeRequest(getActivity());
//                request.setApkversion(((AppViewActivityTV)getActivity()).getVersionName());
//                request.setPackageName(((AppViewActivityTV) getActivity()).getPackage_name());
//                request.setRepo(((AppViewActivityTV) getActivity()).getRepoName());
//                request.setToken(((AppViewActivityTV) getActivity()).getToken());
        ...
        public class AddCommentListener implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                if (accountManager.getAccountsByType(AptoideTV.getConfiguration().getAccountType()).length > 0) {
                    ...
                    accountManager.addAccount(AptoideTV.getConfiguration().getAccountType(), AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS, null, null, getActivity(), null, null);
