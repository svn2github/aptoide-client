            ...
            case 0:
                ...
                holder.overFlow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(Build.VERSION.SDK_INT >= 10) FlurryAgent.logEvent("Store_Category_Grid_View_Opened_Popup_Install");
                        showPopup(v, id);
                    }
                });
    ...
    static class MenuListener implements PopupMenu.OnMenuItemClickListener{
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if (i == R.id.menu_install) {
                ...
                if(Build.VERSION.SDK_INT >= 10) FlurryAgent.logEvent("Store_Category_Grid_View_Installed_App");
                return true;
