        ...
        public void onServiceConnected(ComponentName name, final IBinder service) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        token = accountManager.blockingGetAuthToken(accountManager.getAccountsByType(AptoidePartner.getConfiguration().getAccountType())[0], "Full access", true);
...
//                                                break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user == null) {
            AccountManager.get(this).addAccount(AptoidePartner.getConfiguration().getAccountType(), AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS, null, null, this, new AccountManagerCallback<Bundle>() {
