...
public class LoginActivity extends AccountAuthenticatorActivity implements GooglePlayServicesClient.ConnectionCallbacks, GooglePlayServicesClient.OnConnectionFailedListener, View.OnClickListener, ProgressDialogFragment.OnCancelListener {
    ...
    private void finishLogin(Intent intent) {
        ...
        */
        ...
        ContentResolver.setSyncAutomatically(account, "cm.aptoide.ptdev.UpdatesProvider", true);
        if(Build.VERSION.SDK_INT >= 8) ContentResolver.addPeriodicSync(account, "cm.aptoide.ptdev.UpdatesProvider", new Bundle(), 43200);
        ContentResolver.setSyncAutomatically(account, "cm.aptoide.ptdev.AutoUpdateProvider", true);
