...
public class PrincipalLayoutAdapter extends BaseAdapter {
    ...
    public static abstract class AbstractItem {
        ...
        public abstract View inflateSelf(Context context, int bucketSize);
    ...
    public PrincipalLayoutAdapter(Activity context, ArrayList<Collection> list, boolean b) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null ||
            ...
            convertView = abstractItem.inflateSelf(context, bucketSize);
        }

        abstractItem.fillViewWithData(context, convertView);
...
//        tv.setText(Html.fromHtml(list.get(position).getName()).toString());
        ...
        Log.d("Aptoide-HomeLayout", containerLinearLayout.getChildCount() + "");
