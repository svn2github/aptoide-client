 ...
 */
public class AptoideConfigurationTV extends AptoideConfiguration {
    ...
    private static Context context = AptoideTV.getContext();
    ...
    public static void setPartnerType(String partnerType){ AptoideConfigurationTV.PARTNERTYPE = partnerType; }

    public static String getPartnerId() { return PARTNERID; }
    public static void setPartnerId(String partnerId){ AptoideConfigurationTV.PARTNERID = partnerId; }

    @Override
    public String getDefaultStore() { return DEFAULTSTORENAME; }
    public static void setDefaultStoreName(String defaultStoreName){ AptoideConfigurationTV.DEFAULTSTORENAME = defaultStoreName; }

    public boolean getMatureContentSwitch() { return MATURECONTENTSWITCH; }
    public static void setMatureContentSwitch(boolean matureContentSwitch) { AptoideConfigurationTV.MATURECONTENTSWITCH = matureContentSwitch; }

    public String getSplashscreen(){ return SPLASHSCREEN; }
    public static void setSplashscreen(String splashscreen){ AptoideConfigurationTV.SPLASHSCREEN = splashscreen; }

    public String getSplashscreenLand(){ return SPLASHSCREENLAND; }
    public static void setSplashscreenLand(String splashscreenLand){ AptoideConfigurationTV.SPLASHSCREENLAND = splashscreenLand; }

    public String getBrand(){ return BRAND; }
    public static void setBrand(String stringBrand){ AptoideConfigurationTV.BRAND = stringBrand; }

    public boolean getMatureContentSwitchValue() { return MATURECONTENTSWITCHVALUE; }
    public static void setMatureContentSwitchValue(boolean matureContentSwitchValue) { AptoideConfigurationTV.MATURECONTENTSWITCHVALUE = matureContentSwitchValue; }

    public boolean getMultistores() { return MULTIPLESTORES; }
    public static void setMultistores(boolean multistores) { AptoideConfigurationTV.MULTIPLESTORES = multistores; }

    public boolean getCustomEditorsChoice() { return CUSTOMEDITORSCHOICE; }
    public static void setCustomEditorsChoice(boolean customEditorsChoice) { AptoideConfigurationTV.CUSTOMEDITORSCHOICE = customEditorsChoice; }

    public boolean getSearchStores() { return SEARCHSTORES; }
    public static void setSearchStores(boolean searchStores) { AptoideConfigurationTV.SEARCHSTORES = searchStores; }

    public String getTheme() { return APTOIDETHEME.toUpperCase(Locale.ENGLISH); }
    public static void setTheme(String appTheme) { AptoideConfigurationTV.APTOIDETHEME = appTheme; }

    public String getMarketName(){ return MARKETNAME; }
    public static void setMarketName(String marketName){ AptoideConfigurationTV.MARKETNAME = marketName; }

    public String getAdUnitId(){ return ADUNITID; }
    public static void setAdUnitId(String adUnitId){ AptoideConfigurationTV.ADUNITID = adUnitId; }

    public String getSplashColor(){ return SPLASHCOLOR; }
    public static void setSplashColor(String color){ AptoideConfigurationTV.SPLASHCOLOR = color; }

    public boolean getShowSplash() { return SHOWSPLASH; }
    public static void setShowSplash(boolean showSplash) { AptoideConfigurationTV.SHOWSPLASH = showSplash; }
    ...
    public static void setCreateShortcut(boolean createShortcut) { AptoideConfigurationTV.CREATESHORTCUT = createShortcut; }

    public String getStoreAvatar(){ return AVATAR; }
    public static void setStoreAvatar(String avatar){ AptoideConfigurationTV.AVATAR = avatar; }

    public String getStoreTheme(){ return THEME; }
    public static void setStoreTheme(String theme){ AptoideConfigurationTV.THEME = theme; }

    public String getStoreDescription(){ return DESCRIPTION; }
    public static void setDescription(String description){ AptoideConfigurationTV.DESCRIPTION = description; }

    public String getStoreView(){ return VIEW; }
    public static void setView(String view){ AptoideConfigurationTV.VIEW = view; }
    ...
    public static void setItems(String items){ AptoideConfigurationTV.ITEMS = items; }
    ...
    public Class getStartActivityClass(){
        return cm.aptoidetv.pt.StartTV.class;
    }

    @Override
    public Class getAppViewActivityClass() {
        return cm.aptoidetv.pt.AppViewActivityTV.class;
    }

    @Override
    public Class getSettingsActivityClass() { return cm.aptoidetv.pt.SettingsTV.class; }
...
//    }
    ...
    public String getUpdatesSyncAdapterAuthority(){
        return "cm.aptoidetv.pt.UpdatesProvider";
    }

    @Override
    public String getAutoUpdatesSyncAdapterAuthority(){
        return "cm.aptoidetv.pt.AutoUpdateProvider";
    }

    @Override
    public String getSearchAuthority() {
        return "cm.aptoidetv.pt.SuggestionProviderTV";
    }
...
//    }
    ...
    public Class getMoreEditorsChoiceActivityClass() { return  cm.aptoidetv.pt.MoreEditorsChoiceActitivyTV.class;}
