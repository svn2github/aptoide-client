...
import cm.aptoidetv.pt.Constants;
...
public class RabbitMqService extends Service {
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        ...
        if(!isRunning) {
            ...
            AppTV.setWebInstallServiceRunning(true);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (manager.getAccountsByType(AppTV.getConfiguration().getAccountType()).length > 0) {
                            ...
                            final Account account = AccountManager.get(getApplicationContext()).getAccountsByType(AppTV.getConfiguration().getAccountType())[0];
    ...
    public void onDestroy() {
        ...
        AppTV.setWebInstallServiceRunning(false);
